...
export const getImageSource = (ticker) => {
  ...
  switch (ticker) {
    ...
    case "MSFT": {
      path =
        "https://static.vecteezy.com/system/resources/previews/019/017/460/non_2x/microsoft-transparent-logo-free-png.png";

      break;
    }
    case "AMZN": {
      path =
        "https://banner2.cleanpng.com/20180721/tbz/kisspng-amazon-com-brand-logo-e-commerce-customer-international-volunteering-5b534dc6015e31.6273062615321860540056.jpg";

      break;
    }
    case "FB": {
      path =
        "https://img.freepik.com/free-vector/meta-icon-social-media-flat-graphic-vector-3-november-2021-bangkok-thailand_53876-157871.jpg?w=2000";
      break;
    }
    default: {
      path =
...
export const getInfoAboutCompany = (companyAbbreviation) => {
  ...
  switch (companyAbbreviation) {
    ...
    case "FB": {
      info =
        'Meta Platforms, Inc., formerly named Facebook, Inc., and TheFacebook, Inc., is an American multinational technology conglomerate based in Menlo Park, California. The company owns Facebook, Instagram, and WhatsApp, among other products and services (such as great JavaScript framework ReactJS). Meta is one of the world\'s most valuable companies and among the ten largest publicly traded corporations in the United States. It is considered one of the Big Five American information technology companies, alongside Alphabet (Google), Amazon, Apple, and Microsoft. Meta\'s products and services include Facebook, Instagram, WhatsApp, Messenger, and Meta Quest. It has acquired Oculus, Mapillary, CTRL-Labs, Kustomer, and has a 9.99% stake in Jio Platforms. In 2021, the company generated 97.5% of its revenue from the sale of advertising. On October 28, 2021, the parent company of Facebook changed its name from Facebook, Inc., to Meta Platforms, Inc., to "reflect its focus on building the metaverse". According to Meta, the "metaverse" refers to the integrated environment that links all of the company\'s products and services.';
      break;
    }
    default: {
      info =
